...
namespace OpcodeDiffer
{
    ...
    public class ProtoDumpDB : SQLiteDB
    {
            ...
            : base(dbPath)
        {
            ...
            // Get DB version
            SQLiteCommand getDbVersion = new SQLiteCommand("SELECT * FROM Version");
            SQLiteDataReader versionReader = getDbVersion.ExecuteReader();

            dbVersion = new Version(versionReader.GetInt32(1), versionReader.GetDouble(2));
    ...
    public class DumpDB : ProtoDumpDB
    {
        ...
        public CMSG CMSG_Get(int opcode)
        {
            ...
            // Execute Query
            SQLiteDataReader reader = CMSG_get.ExecuteReader();
            return new CMSG(reader.GetInt32(1), (UInt32)reader.GetInt32(2), (UInt32)reader.GetInt32(3), (UInt32)reader.GetInt32(4));
        }
        public SMSG SMSG_Get(int opcode)
        {
            ...
            // Execute Query
            SQLiteDataReader reader = SMSG_get.ExecuteReader();
            return new SMSG(reader.GetInt32(1), (UInt32)reader.GetInt32(2), (UInt32)reader.GetInt32(3), (UInt32)reader.GetInt32(4));
        }
    }
}
